...
export const EXTRACT_TEXT_PROMPT = `Ekstrak SEMUA nomor telepon (misal: 08123456789, +62812...), nomor rekening bank, URL (domain/link), dan alamat email yang terdapat di dalam teks berikut.

Aturan:
- Balas HANYA JSON array of string. Tanpa penjelasan, tanpa markdown fence.
- Salin nilai apa adanya seperti tertulis di dalam teks.
- Jika tidak ada entitas sama sekali, balas: []
